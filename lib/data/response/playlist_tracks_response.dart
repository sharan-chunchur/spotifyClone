class PlaylistsTracksResponse {
  ...
  PlaylistsTracksResponse.fromJson(Map<String, dynamic> json) {
    if (json['items'] != null) {
      items = <TrackItems>[];
      json['items'].forEach((v) {
        items!.add(new TrackItems.fromJson(v));
      });
    }
    limit = json['limit'];
    next = json['next'];
...
class TrackItems {
  ...
  TrackItems.fromJson(Map<String, dynamic> json) {
    ...
    sharingInfo = json['sharing_info'] != null
        ? new SharingInfo.fromJson(json['sharing_info'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.sharingInfo != null) {
      data['sharing_info'] = this.sharingInfo!.toJson();
    }
    if (this.track != null) {
...
class Track {
  ...
  Track.fromJson(Map<String, dynamic> json) {
    ...
    linkedFrom = json['linked_from'] != null
        ? new AddedBy.fromJson(json['linked_from'])
        : null;
  }
